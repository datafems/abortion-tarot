  ...
  <div class="screen-container">
    ...
    <section class="methodology-container">
      <div class="methodology-content" style="text-align:justify;">
        ...
        {#if expanded}
        <p>ระยะเวลา 5 ปี ผู้เขียนและครอบครัวต่างสายพันธุ์ติดตามการแก้ไขเพิ่มเติมประมวลกฎหมายอาญา (ฉบับที่ 26) พ.ศ.2564 ข้อมูลโรงพยาบาล/คลินิกที่เปิดเผยบริการทำแท้งปลอดภัยยังคงไม่เปิดเผยทั้งหมด เนื่องจากอคติ การตีตราของผู้ให้บริการและสังคม หรือเหตุผลข้อจำกัดต่างๆ</p>
        ...
        <p>ผู้เขียนจึงอาศัยแหล่งข้อมูลหน่วยบริการที่มีศักยภาพบริการยุติการตั้งครรภ์จากสปสช. ประกอบ 
